...
def sample_points_pre_face(vertices, faces, n_point_per_face=2000):
    ...
    # Extract three vertices per face
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--mesh_path", type=str, default="assets/1.glb", help="Input mesh path"
    )
    argparser.add_argument(
    ...
    argparser.add_argument(
        "--save_mid_res", type=int, default=1, help="Save intermediate results"
    )
    argparser.add_argument("--show_info", type=int, default=1, help="Show info")
    argparser.add_argument(
        "--show_time_info", type=int, default=1, help="Show timing info"
    )
    argparser.add_argument("--seed", type=int, default=42, help="Random seed")
    argparser.add_argument("--parallel", type=int, default=1, help="Use multi-GPU")
    argparser.add_argument(
        "--prompt_bs", type=int, default=32, help="Prompt inference batch size"
    )
